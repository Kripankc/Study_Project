...
def plot_raw_vs_top3_smoothing():
    ...
    # Align stations and precipitation
    ...
    # Top 3 combinations from A6.finding_best (adjust if needed)
    top_3 = [
        (135, 55, 8),
        (90, 45, 4),
        (180, 65, 2)
